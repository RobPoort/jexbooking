...
class JexBookingModelType extends JModelAdmin
{
	/**
	...
	*/
	public function getTable($type = 'Types', $prefix = 'JexBookingTable', $config = array())
	{
	...
	{
		//get the form
		$form = $this->loadForm('com_jexbooking.type', 'type', array('control'=>'jform', 'load_data'=>$loadData));
		if(empty($form))
		{
			return false;
		}
	...
	{
		return 'administrator/components/com_jexbooking/models/forms/type.js';
	}
	/**
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jexbooking.edit.type.data', array());
		if(empty($data))
		{
			$data = $this->getItem();
		}
