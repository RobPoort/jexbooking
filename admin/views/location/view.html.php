...
class JexBookingViewLocation extends JView
{
	...
	protected function addToolBar()
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_JEXBOOKING_MANAGER_LOCATION_NEW')
		: JText::_('COM_JEXBOOKING_MANAGER_LOCATION_EDIT'), 'jexbooking');
	...
	protected function setDocument()
	{
		...
		$document->setTitle($isNew ? JText::_('COM_JEXBOOKING_LOCATION_CREATING') : JTEXT::_('COM_JEXBOOKING_LOCATION_EDITING'));
