...
class JexBookingTableAttributes extends JTable
{
	/**
	*	constructor
	...
	*/
	function __construct(&$db){
		parent::__construct('#__jexbooking_attributes', 'id', $db);
	}
	...
	*/
	...
	{
		$k = $this->_tbl_key;
		return 'com_jexbooking.message.'.(int)$this->$k;
	}
	...
	*/
	protected function _getAssetParentId()
	{
		...
		$asset->loadByName('com_jexbooking');
